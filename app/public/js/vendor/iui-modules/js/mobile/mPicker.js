 ...
 * mPicker 组件
 *
 * github地址：https://github.com/qiuyaofan/mobileSelector
 * *** options ***
 *
 ...
 * @param {function}                            disabled: function() {}
 *
 * *** 关于json格式 ***
...
module.exports = {
    mPicker : function (options) {
        ...
        MPicker.prototype = {
            ...
            showPicker : function () {
                var self = this;
                var mdisabled = self.container.prop('disabled');
                var dcallback = self.options.disabled;
            ...
            event : function () {
                 ...
                 */
                var self = this;
                this.container.off('click.container').on('click.container', function (e) {
                    e.preventDefault();
                    e.stopPropagation();
                    self.showPicker();
                });
